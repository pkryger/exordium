...
If you install an external tool [`difftastic`](https://difftastic.wilfred.me.uk) to perform structural diffs.
When in `magit-diff` or `magit-blame` transient, or in `magit-blame-read-only-mode`:
